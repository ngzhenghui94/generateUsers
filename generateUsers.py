...
with open('userTestData.csv','w', newline='') as csv_file:
    ...
    writer.writerow(["id","email","fullName","password","gender","age","country","description"])
    id = 0
    tourid  = 0
    for i in range(0,200):
        ...
        email = fullName = fullName.replace(" ", "") + ranEmailDomain
        #generate Age
        ...
        row = [id, email, fullName, password, gender, age, country, description]
        writer.writerow(row)
    csv_file.close()
